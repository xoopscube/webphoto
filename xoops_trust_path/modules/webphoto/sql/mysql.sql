...
(
    ...
    item_ext                VARCHAR(191)         NOT NULL DEFAULT '',
    item_datetime           DATETIME             NOT NULL,
    item_title              VARCHAR(191)         NOT NULL DEFAULT '',
    item_place              VARCHAR(191)         NOT NULL DEFAULT '',
    item_equipment          VARCHAR(191)         NOT NULL DEFAULT '',
    ...
    item_perm_read          VARCHAR(191)         NOT NULL DEFAULT '',
    ...
    item_text_1             VARCHAR(191)         NOT NULL DEFAULT '',
    item_text_2             VARCHAR(191)         NOT NULL DEFAULT '',
    item_text_3             VARCHAR(191)         NOT NULL DEFAULT '',
    item_text_4             VARCHAR(191)         NOT NULL DEFAULT '',
    item_text_5             VARCHAR(191)         NOT NULL DEFAULT '',
    item_text_6             VARCHAR(191)         NOT NULL DEFAULT '',
    item_text_7             VARCHAR(191)         NOT NULL DEFAULT '',
    item_text_8             VARCHAR(191)         NOT NULL DEFAULT '',
    item_text_9             VARCHAR(191)         NOT NULL DEFAULT '',
    item_text_10            VARCHAR(191)         NOT NULL DEFAULT '',
    ...
    item_siteurl            VARCHAR(191)         NOT NULL DEFAULT '',
    item_artist             VARCHAR(191)         NOT NULL DEFAULT '',
    item_album              VARCHAR(191)         NOT NULL DEFAULT '',
    item_label              VARCHAR(191)         NOT NULL DEFAULT '',
    item_perm_down          VARCHAR(191)         NOT NULL DEFAULT '',
    item_external_url       VARCHAR(191)         NOT NULL DEFAULT '',
    item_external_thumb     VARCHAR(191)         NOT NULL DEFAULT '',
    item_embed_type         VARCHAR(191)         NOT NULL DEFAULT '',
    item_embed_src          VARCHAR(191)         NOT NULL DEFAULT '',
    item_playlist_feed      VARCHAR(191)         NOT NULL DEFAULT '',
    item_playlist_dir       VARCHAR(191)         NOT NULL DEFAULT '',
    item_playlist_cache     VARCHAR(191)         NOT NULL DEFAULT '',
    item_playlist_type      INT(11) UNSIGNED     NOT NULL DEFAULT '0',
    item_playlist_time      INT(11) UNSIGNED     NOT NULL DEFAULT '0',
    item_showinfo           VARCHAR(191)         NOT NULL DEFAULT '',
    item_external_middle    VARCHAR(191)         NOT NULL DEFAULT '',
    item_icon_name          VARCHAR(191)         NOT NULL DEFAULT '',
    item_codeinfo           VARCHAR(191)         NOT NULL DEFAULT '',
    ...
    item_editor             VARCHAR(191)         NOT NULL DEFAULT '',
...
(
    ...
    file_mime        VARCHAR(191)         NOT NULL DEFAULT '',
    file_medium      VARCHAR(191)         NOT NULL DEFAULT '',
...
(
    ...
    photo_title          VARCHAR(191)     NOT NULL DEFAULT '',
    photo_place          VARCHAR(191)     NOT NULL DEFAULT '',
    photo_equipment      VARCHAR(191)     NOT NULL DEFAULT '',
    photo_file_url       VARCHAR(191)     NOT NULL DEFAULT '',
    photo_file_path      VARCHAR(191)     NOT NULL DEFAULT '',
    photo_file_name      VARCHAR(191)     NOT NULL DEFAULT '',
    photo_file_ext       VARCHAR(10)      NOT NULL DEFAULT '',
    photo_file_mime      VARCHAR(191)     NOT NULL DEFAULT '',
    photo_file_medium    VARCHAR(191)     NOT NULL DEFAULT '',
    photo_file_size      INT(5)           NOT NULL DEFAULT '0',
    photo_cont_url       VARCHAR(191)     NOT NULL DEFAULT '',
    photo_cont_path      VARCHAR(191)     NOT NULL DEFAULT '',
    photo_cont_name      VARCHAR(191)     NOT NULL DEFAULT '',
    photo_cont_ext       VARCHAR(10)      NOT NULL DEFAULT '',
    photo_cont_mime      VARCHAR(191)     NOT NULL DEFAULT '',
    photo_cont_medium    VARCHAR(191)     NOT NULL DEFAULT '',
    ...
    photo_thumb_url      VARCHAR(191)     NOT NULL DEFAULT '',
    photo_thumb_path     VARCHAR(191)     NOT NULL DEFAULT '',
    photo_thumb_name     VARCHAR(191)     NOT NULL DEFAULT '',
    photo_thumb_ext      VARCHAR(10)      NOT NULL DEFAULT '',
    photo_thumb_mime     VARCHAR(191)     NOT NULL DEFAULT '',
    photo_thumb_medium   VARCHAR(191)     NOT NULL DEFAULT '',
    ...
    photo_perm_read      VARCHAR(191)     NOT NULL DEFAULT '',
    photo_text1          VARCHAR(191)     NOT NULL DEFAULT '',
    photo_text2          VARCHAR(191)     NOT NULL DEFAULT '',
    photo_text3          VARCHAR(191)     NOT NULL DEFAULT '',
    photo_text4          VARCHAR(191)     NOT NULL DEFAULT '',
    photo_text5          VARCHAR(191)     NOT NULL DEFAULT '',
    photo_text6          VARCHAR(191)     NOT NULL DEFAULT '',
    photo_text7          VARCHAR(191)     NOT NULL DEFAULT '',
    photo_text8          VARCHAR(191)     NOT NULL DEFAULT '',
    photo_text9          VARCHAR(191)     NOT NULL DEFAULT '',
    photo_text10         VARCHAR(191)     NOT NULL DEFAULT '',
...
(
    ...
    cat_img_path       VARCHAR(191)     NOT NULL DEFAULT '',
    cat_weight         INT(5) UNSIGNED  NOT NULL DEFAULT 0,
    cat_depth          INT(5) UNSIGNED  NOT NULL DEFAULT 0,
    cat_allowed_ext    VARCHAR(191)     NOT NULL DEFAULT 'jpg|jpeg|gif|png',
    ...
    cat_perm_read      VARCHAR(191)     NOT NULL DEFAULT '',
    cat_perm_post      VARCHAR(191)     NOT NULL DEFAULT '',
    cat_text1          VARCHAR(191)     NOT NULL DEFAULT '',
    cat_text2          VARCHAR(191)     NOT NULL DEFAULT '',
    cat_text3          VARCHAR(191)     NOT NULL DEFAULT '',
    cat_text4          VARCHAR(191)     NOT NULL DEFAULT '',
    cat_text5          VARCHAR(191)     NOT NULL DEFAULT '',
    cat_description    TEXT,
    cat_img_name       VARCHAR(191)     NOT NULL DEFAULT '',
...
(
    ...
    gicon_title         VARCHAR(191)     NOT NULL DEFAULT '',
    gicon_image_path    VARCHAR(191)     NOT NULL DEFAULT '',
    gicon_image_name    VARCHAR(191)     NOT NULL DEFAULT '',
    gicon_image_ext     VARCHAR(10)      NOT NULL DEFAULT '',
    gicon_shadow_path   VARCHAR(191)     NOT NULL DEFAULT '',
    gicon_shadow_name   VARCHAR(191)     NOT NULL DEFAULT '',
...
(
    ...
    mime_medium      VARCHAR(191)     NOT NULL DEFAULT '',
    mime_type        VARCHAR(191)     NOT NULL DEFAULT '',
    mime_name        VARCHAR(191)     NOT NULL DEFAULT '',
    mime_perms       VARCHAR(191)     NOT NULL DEFAULT '',
    mime_ffmpeg      VARCHAR(191)     NOT NULL DEFAULT '',
    mime_kind        INT(4)           NOT NULL DEFAULT '0',
    mime_option      VARCHAR(191)     NOT NULL DEFAULT '',
...
(
    ...
    tag_name        VARCHAR(191)     NOT NULL DEFAULT '',
    PRIMARY KEY (tag_id),
    KEY (tag_name(40))
) ENGINE = InnoDB;
...
(
    ...
    syno_key         VARCHAR(191)     NOT NULL DEFAULT '',
    syno_value       VARCHAR(191)     NOT NULL DEFAULT '',
    PRIMARY KEY (syno_id)
) ENGINE = InnoDB;
...
(
    ...
    user_text1       VARCHAR(191)     NOT NULL DEFAULT '',
    user_text2       VARCHAR(191)     NOT NULL DEFAULT '',
    user_text3       VARCHAR(191)     NOT NULL DEFAULT '',
    user_text4       VARCHAR(191)     NOT NULL DEFAULT '',
    user_text5       VARCHAR(191)     NOT NULL DEFAULT '',
    PRIMARY KEY (user_id),
    KEY (user_uid),
    KEY (user_cat_id),
    KEY (user_email(40))
...
(
    ...
    maillog_photo_ids   VARCHAR(191)     NOT NULL DEFAULT '',
    maillog_status      TINYINT(2)       NOT NULL DEFAULT '0',
    maillog_from        VARCHAR(191)     NOT NULL DEFAULT '',
    maillog_subject     VARCHAR(191)     NOT NULL DEFAULT '',
    maillog_body        VARCHAR(191)     NOT NULL DEFAULT '',
    maillog_file        VARCHAR(191)     NOT NULL DEFAULT '',
...
(
    ...
    flashvar_file                VARCHAR(191)     NOT NULL DEFAULT '',
    flashvar_image               VARCHAR(191)     NOT NULL DEFAULT '',
    flashvar_logo                VARCHAR(191)     NOT NULL DEFAULT '',
    flashvar_link                VARCHAR(191)     NOT NULL DEFAULT '',
    flashvar_audio               VARCHAR(191)     NOT NULL DEFAULT '',
    flashvar_captions            VARCHAR(191)     NOT NULL DEFAULT '',
    flashvar_fallback            VARCHAR(191)     NOT NULL DEFAULT '',
    flashvar_callback            VARCHAR(191)     NOT NULL DEFAULT '',
    flashvar_javascriptid        VARCHAR(191)     NOT NULL DEFAULT '',
    flashvar_recommendations     VARCHAR(191)     NOT NULL DEFAULT '',
    flashvar_streamscript        VARCHAR(191)     NOT NULL DEFAULT '',
    flashvar_searchlink          VARCHAR(191)     NOT NULL DEFAULT '',
    ...
    flashvar_playlistfile        VARCHAR(191)     NOT NULL DEFAULT '',
    flashvar_mediaid             VARCHAR(191)     NOT NULL DEFAULT '',
    flashvar_provider            VARCHAR(191)     NOT NULL DEFAULT '',
    flashvar_streamer            VARCHAR(191)     NOT NULL DEFAULT '',
    flashvar_netstreambasepath   VARCHAR(191)     NOT NULL DEFAULT '',
    flashvar_skin                VARCHAR(191)     NOT NULL DEFAULT '',
    flashvar_player_repeat       VARCHAR(191)     NOT NULL DEFAULT '',
    flashvar_playerready         VARCHAR(191)     NOT NULL DEFAULT '',
    flashvar_plugins             VARCHAR(191)     NOT NULL DEFAULT '',
    flashvar_stretching          VARCHAR(191)     NOT NULL DEFAULT '',
    flashvar_controlbar_position VARCHAR(191)     NOT NULL DEFAULT '',
    flashvar_playlist_position   VARCHAR(191)     NOT NULL DEFAULT '',
    flashvar_logo_file           VARCHAR(191)     NOT NULL DEFAULT '',
    flashvar_logo_link           VARCHAR(191)     NOT NULL DEFAULT '',
    flashvar_logo_linktarget     VARCHAR(191)     NOT NULL DEFAULT '',
    flashvar_logo_position       VARCHAR(191)     NOT NULL DEFAULT '',
...
#
INSERT INTO gicon
VALUES (1, 0, 0, 'aqua 18x28', '/modules/{DIRNAME}/images/markers/icon_1828_aqua.png', '', 'png', '', '', '', 18, 28, 0,
        0, 9, 28, 9, 3);
INSERT INTO gicon
VALUES (2, 0, 0, 'blue 18x28', '/modules/{DIRNAME}/images/markers/icon_1828_blue.png', '', 'png', '', '', '', 18, 28, 0,
        0, 9, 28, 9, 3);
INSERT INTO gicon
VALUES (3, 0, 0, 'gray 18x28', '/modules/{DIRNAME}/images/markers/icon_1828_gray.png', '', 'png', '', '', '', 18, 28, 0,
        0, 9, 28, 9, 3);
INSERT INTO gicon
VALUES (4, 0, 0, 'green 18x28', '/modules/{DIRNAME}/images/markers/icon_1828_green.png', '', 'png', '', '', '', 18, 28,
        0, 0, 9, 28, 9, 3);
INSERT INTO gicon
VALUES (5, 0, 0, 'maroon 18x28', '/modules/{DIRNAME}/images/markers/icon_1828_maroon.png', '', 'png', '', '', '', 18,
        28, 0, 0, 9, 28, 9, 3);
INSERT INTO gicon
VALUES (6, 0, 0, 'pink 18x28', '/modules/{DIRNAME}/images/markers/icon_1828_pink.png', '', 'png', '', '', '', 18, 28, 0,
        0, 9, 28, 9, 3);
INSERT INTO gicon
VALUES (7, 0, 0, 'purple 18x28', '/modules/{DIRNAME}/images/markers/icon_1828_purple.png', '', 'png', '', '', '', 18,
        28, 0, 0, 9, 28, 9, 3);
INSERT INTO gicon
VALUES (8, 0, 0, 'red 18x28', '/modules/{DIRNAME}/images/markers/icon_1828_red.png', '', 'png', '', '', '', 18, 28, 0,
        0, 9, 28, 9, 3);
INSERT INTO gicon
VALUES (9, 0, 0, 'white 18x28', '/modules/{DIRNAME}/images/markers/icon_1828_white.png', '', 'png', '', '', '', 18, 28,
        0, 0, 9, 28, 9, 3);
INSERT INTO gicon
VALUES (10, 0, 0, 'yellow 18x28', '/modules/{DIRNAME}/images/markers/icon_1828_yellow.png', '', 'png', '', '', '', 18,
        28, 0, 0, 9, 28, 9, 3);
...
INSERT INTO mime
VALUES (1, 0, 0, '3g2', 'video', 'video/3gpp2', 'Third Generation Partnership Project 2 File Format', '&1&', '', 21,
        'ffmpeg:-ar 44100;');
INSERT INTO mime
VALUES (2, 0, 0, '3gp', 'video', 'video/3gpp', 'Third Generation Partnership Project File Format', '&1&', '', 21,
        'ffmpeg:-ar 44100;');
INSERT INTO mime
VALUES (3, 0, 0, 'asf', 'video', 'video/x-ms-asf', 'Advanced Systems Format', '&1&', '', 21, 'ffmpeg:-ar 44100;');
INSERT INTO mime
VALUES (4, 0, 0, 'avi', 'video', 'video/x-msvideo video/avi', 'Audio Video Interleave File', '&1&', '', 21,
        'ffmpeg:-ar 44100;');
INSERT INTO mime
VALUES (5, 0, 0, 'bmp', 'image', 'image/bmp', 'Windows OS/2 Bitmap Graphics', '&1&', '', 11, '');
INSERT INTO mime
VALUES (6, 0, 0, 'doc', '', 'application/msword', 'Word Document', '&1&', '', 41, '');
INSERT INTO mime
VALUES (7, 0, 0, 'flv', 'video', 'video/x-flv application/octet-stream', 'Flash Video', '&1&', '-ar 44100', 20,
        'ffmpeg:-ar 44100;');
INSERT INTO mime
VALUES (8, 0, 0, 'gif', 'image', 'image/gif', 'Graphic Interchange Format', '&1&2&', '', 10, '');
INSERT INTO mime
VALUES (9, 0, 0, 'jpg', 'image', 'image/jpeg image/pjpeg', 'JPEG/JIFF Image', '&1&2&', '', 12, '');
INSERT INTO mime
VALUES (10, 0, 0, 'jpeg', 'image', 'image/jpeg image/pjpeg', 'JPEG/JIFF Image', '&1&2&', '', 12, '');
INSERT INTO mime
VALUES (11, 0, 0, 'mid', 'audio', 'audio/mid', 'Musical Instrument Digital Interface MIDI-sequention Sound', '&1&', '',
        31, '');
INSERT INTO mime
VALUES (12, 0, 0, 'mov', 'video', 'video/quicktime', 'QuickTime Video Clip', '&1&', '', 21, 'ffmpeg:-ar 44100;');
INSERT INTO mime
VALUES (13, 0, 0, 'mp3', 'audio', 'audio/mpeg audio/mp3', 'MPEG Audio Stream, Layer III', '&1&', '', 30, '');
INSERT INTO mime
VALUES (14, 0, 0, 'mpeg', 'video', 'video/mpeg', 'MPEG Movie', '&1&', '', 21, 'ffmpeg:-ar 44100;');
INSERT INTO mime
VALUES (15, 0, 0, 'mpg', 'video', 'video/mpeg', 'MPEG 1 System Stream', '&1&', '', 21, 'ffmpeg:-ar 44100;');
INSERT INTO mime
VALUES (16, 0, 0, 'pdf', '', 'application/pdf', 'Acrobat Portable Document Format', '&1&', '', 44, '');
INSERT INTO mime
VALUES (17, 0, 0, 'png', 'image', 'image/png image/x-png', 'Portable (Public) Network Graphic', '&1&2&', '', 10, '');
INSERT INTO mime
VALUES (18, 0, 0, 'ppt', '', 'application/vnd.ms-powerpoint', 'MS Power Point', '&1&', '', 43, '');
INSERT INTO mime
VALUES (19, 0, 0, 'ram', 'audio', 'audio/x-pn-realaudio', 'RealMedia Metafile', '&1&', '', 30, '');
INSERT INTO mime
VALUES (20, 0, 0, 'rar', '', 'application/x-rar-compressed', 'WinRAR Compressed Archive', '&1&', '', 0, '');
INSERT INTO mime
VALUES (21, 0, 0, 'swf', '', 'application/x-shockwave-flash', 'Macromedia Flash Format File', '&1&', '', 0, '');
INSERT INTO mime
VALUES (22, 0, 0, 'txt', '', 'text/plain', 'Text File', '&1&', '', 0, '');
INSERT INTO mime
VALUES (23, 0, 0, 'wav', 'audio', 'audio/wav audio/x-wav', 'Waveform Audio', '&1&', '', 32, '');
INSERT INTO mime
VALUES (24, 0, 0, 'wmv', 'video', 'video/x-ms-wmv', 'Windows Media File', '&1&', '', 21, 'ffmpeg:-ar 44100;');
INSERT INTO mime
VALUES (25, 0, 0, 'xls', '', 'application/vnd.ms-excel', 'MS Excel', '&1&', '', 42, '');
INSERT INTO mime
VALUES (26, 0, 0, 'zip', '', 'application/zip', 'Compressed Archive File', '&1&', '', 0, '');
INSERT INTO mime
VALUES (27, 0, 0, 'ai', '', 'application/postscript', 'Adobe Illustrator', '&1&', '', 11, '');
INSERT INTO mime
VALUES (28, 0, 0, 'eps', '', 'application/postscript', 'Encapsulated PostScript', '&1&', '', 11, '');
INSERT INTO mime
VALUES (29, 0, 0, 'pct', '', 'image/x-pict', 'Apple Macintosh QuickDraw/PICT', '&1&', '', 11, '');
INSERT INTO mime
VALUES (30, 0, 0, 'psd', '', 'image/x-photshop', 'Adobe Photoshop', '&1&', '', 11, 'convert:--flatten');
INSERT INTO mime
VALUES (31, 0, 0, 'tif', '', 'image/tiff', 'Tag Image File Format', '&1&', '', 11, '');
INSERT INTO mime
VALUES (32, 0, 0, 'wmf', '', 'image/wmf application/octet-stream', 'Windows Meta File', '&1&', '', 11, '');

INSERT INTO mime
VALUES (33, 0, 0, 'docx', '', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 'MS Word 2007',
        '&1&', '', 41, '');
INSERT INTO mime
VALUES (34, 0, 0, 'pptx', '', 'application/vnd.openxmlformats-officedocument.presentationml.presentation',
        'MS Power Point 2007', '&1&', '', 43, '');
INSERT INTO mime
VALUES (35, 0, 0, 'xltx', '', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', 'MS Excel 2007',
        '&1&', '', 42, '');

# v2.30
INSERT INTO mime
VALUES (36, 0, 0, 'svg', '', 'image/svg+xml', 'Scalable Vector Graphics', '&1&', '', 11, 'convert:-size 1200;');
INSERT INTO mime
VALUES (37, 0, 0, 'wma', '', 'audio/x-ms-wma', 'Windows Media Audio', '&1&', '', 34, '');
INSERT INTO mime
VALUES (38, 0, 0, 'aif', '', 'audio/aiff', 'Audio Interchange File Format', '&1&', '', 34, '');
INSERT INTO mime
VALUES (39, 0, 0, 'aifc', '', 'audio/aiff', 'Audio Interchange File Format', '&1&', '', 34, '');
INSERT INTO mime
VALUES (40, 0, 0, 'aiff', '', 'audio/aiff', 'Audio Interchange File Format', '&1&', '', 34, '');
INSERT INTO mime
VALUES (41, 0, 0, 'au', '', 'audio/basic', 'Audio UNIX', '&1&', '', 34, '');
INSERT INTO mime
VALUES (42, 0, 0, 'snd', '', 'audio/basic', 'Sound UNIX', '&1&', '', 34, '');
INSERT INTO mime
VALUES (43, 0, 0, 'ivf', '', 'application/octet-stream', 'Indeo Video Files', '&1&', '', 34, '');
INSERT INTO mime
VALUES (44, 0, 0, 'midi', '', 'audio/mid', 'Musical Instrument Digital Interface MIDI-sequention Sound', '&1&', '', 31,
        '');
INSERT INTO mime
VALUES (45, 0, 0, 'rmi', '', 'audio/mid', 'Musical Instrument Digital Interface MIDI-sequention Sound', '&1&', '', 31,
        '');
INSERT INTO mime
VALUES (46, 0, 0, 'mpa', '', 'video/x-mpg', 'MPEG-1 Audio Layer-III', '&1&', '', 34, 'ffmpeg:-ar 44100');
INSERT INTO mime
VALUES (47, 0, 0, 'm1v', '', 'video/mpeg video/x-mpeg', 'MPEG-1 Audio Layer-III', '&1&', '', 21, 'ffmpeg:-ar 44100');
INSERT INTO mime
VALUES (48, 0, 0, 'mpe', '', 'video/mpeg video/x-mpeg', 'MPEG-1 Audio Layer-III', '&1&', '', 21, 'ffmpeg:-ar 44100');
INSERT INTO mime
VALUES (49, 0, 0, 'mp4', '', 'video/mp4 video/mpeg4', 'MPEG-4', '&1&', '', 21, 'ffmpeg:-ar 44100');
...
INSERT INTO player
VALUES (1, 0, 0, 'default', 0, 260, 320, 0, 0, '', '', '', '');
INSERT INTO player
VALUES (2, 0, 0, 'playlist default', 0, 260, 320, 260, 220, '', '', '', '');
