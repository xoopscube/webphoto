...
// Index (Categories)
	...
	define( "_AM_WEBPHOTO_CAT_MENU_NEW", "Nouvelle Catégorie" );
...
//---------------------------------------------------------
	...
	define( "_AM_WEBPHOTO_PARENT", "Catégorie parent:" );
	...
	define( "_AM_WEBPHOTO_ERRORTITLE", "Erreur: saisir un titre!" );
	define( "_AM_WEBPHOTO_ERRORDESC", "Erreur: saisir une description!" );
	define( "_AM_WEBPHOTO_WEAPPROVED", "Le lien proposé a été enregistré dans la base de données." );
	define( "_AM_WEBPHOTO_THANKSSUBMIT", "Merci de votre participation !" );
