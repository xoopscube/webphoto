...
class webphoto_admin_import extends webphoto_edit_import {
	...
	public $_image_cat_row = null;

	public $_webphoto_dirname;
	public $_webphoto_mid;
	public $_webphoto_photos_path;
	public $_webphoto_thumbs_path;
	public $_webphoto_cat_handler;
	public $_webphoto_item_create_class;
